...
export default async function DashboardPage() {
	...
	return (
		<>
			...
			<div>
				<div className="flex gap-4 h-16 items-center justify-between px-10">
					<Link
						className="space-y-4 text-sm text-muted-foreground"
						href="https://ui.shadcn.com/examples/dashboard"
					>
						this is almost exactly the dashboard example code from shadcn/ui
					</Link>
					<Link
						className="space-y-4 text-sm text-muted-foreground"
						href="https://www.learnwithjason.dev"
					>
						a Learn With Jason project
					</Link>
					<Link
						className="space-y-4 text-sm text-muted-foreground"
						href="https://authkit.com"
					>
						built with AuthKit
					</Link>
				</div>
